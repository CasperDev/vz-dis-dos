...
l217fh:
	...
	ld a,(TapeInputFlag)	; a - input from tape Flag 							;2186	3a a9 78 	: . x 
...
CmdINPUT
	...
	sub '#'		;21a1	d6 23 	. # 
	ld (TapeInputFlag),a	; set as input from tape Flag (0-true, other-false)	;21a3	32 a9 78 	2 . x 
	ld a,(hl)			;21a6	7e 	~ 
...
l21fdh:
	...
	ld a,(TapeInputFlag)	; a - input from tape Flag 									;220e	3a a9 78 	: . x 
